...
ActiveResource 的实现比较短，从中可以看出它并没有使用 LRU 功能进行资源管理，而是采用了弱引用 + 引用队列的方式来判断哪些资源可以被复用、哪些资源需要回收。
...
| ![img](images/11462765-5ad875863445b4f1.png) | ![img](images/format,png.png) |
| -------------------------------------------- | ----------------------------- |
