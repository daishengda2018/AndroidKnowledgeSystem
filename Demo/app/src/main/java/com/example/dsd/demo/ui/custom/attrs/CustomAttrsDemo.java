...
public class CustomAttrsDemo extends android.support.v7.widget.AppCompatTextView {
    ...
    public CustomAttrsDemo(Context context, AttributeSet attrs) {
        ...
        mTextColor = array.getColor(R.styleable.CustomAttrsDemo_text_color, Color.BLACK);
        mTextSize = array.getDimensionPixelSize(R.styleable.CustomAttrsDemo_text_size, 18);
        // 注意使用完成之后一定要回收
        array.recycle();
    }
